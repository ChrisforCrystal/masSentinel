...
- [x] **Phase 2: Sidecar User-space Logic**
    ...
    - [x] Update `proxy/outbound.rs` to use `Map_Reader` instead of `SO_ORIGINAL_DST` <!-- id: 302 -->
...
- [ ] **Phase 3: Integration & Testing**
    ...
    - [x] Build Docker image including eBPF binary (`deploy/Dockerfile.ebpf`) <!-- id: 401 -->
    - [/] Verify traffic interception with `demo-app` (See `verification.md`) <!-- id: 402 -->
